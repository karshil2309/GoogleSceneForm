...
public class MainActivity extends AppCompatActivity {
    ...
    private void initializeGallery() {
        ...
        andy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MainActivity.this.addObject(Uri.parse("andy_dance.sfb"));
            }
        });
        ...
        cabin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MainActivity.this.addObject(Uri.parse("Cabin.sfb"));
            }
        });
        ...
        house.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MainActivity.this.addObject(Uri.parse("House.sfb"));
            }
        });
        ...
        igloo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MainActivity.this.addObject(Uri.parse("igloo.sfb"));
            }
        });
